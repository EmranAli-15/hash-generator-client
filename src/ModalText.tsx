  ...
  return (
    <div>
      ...
      <p className="mt-5 text-[18px] text-justify" >
        We often use or have to use somewhat complex passwords for security purposes. However, there are some applications where you don't need to log in and out frequently, like Gmail. In fact, each of us has several Gmail or Facebook accounts. Often, we forget the passwords for these accounts and find ourselves in an annoying situation. As a result, many people write them down in a notebook, which is not convenient, as it can be stolen at any moment.
        < br /> <br />
        To solve this problem, this <span className="font-bold" > Hash Generator </span> web application was created.
        < br /> <br />
...
export function BanglaText() {
  return (
    <div>
      ...
      <p className="mt-5 text-[18px] text-justify">
        আমারা সিকিউরিটির জন্য বিভিন্য অ্যাকাউন্টে সচারচর একটু জটিল পাসওয়ার্ড ব্যবহার করে থাকি বা করতে হয়। তবে কিছু কিছু অ্যাপ্লিকেশন আছে যেখানে খুব একটা লগিন-লগআউট করতে হয় না যেমনঃ Gmail । এমনকি আমাদের একএক জনের বেশ কয়েকটা করে এই Gmail অথবা Facebook অ্যাকাউন্ট আছে। প্রায় সময়ই আমরা এগুলোর পাসওয়ার্ড ভুলে যাই এবং পড়তে হয় বিরক্তিকর অবস্থায়। যার কারনে অনেকে নোট খাতায় লিখে রাখে যা কিনা মোটেও সুবিধার না, কারণ যেকোন মুহূর্তে এটা চুরি হতে পারে।
        <br /><br />
        ঠিক এই সমস্যা সমাধানের জন্যই বানানো হয়েছে এই<span className="font-bold"> হ্যাস জেনারেটর</span> ওয়েব অ্যাপ্লিকেশনটি।
        <br /><br />
