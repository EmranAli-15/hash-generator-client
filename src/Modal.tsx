...
export default function Modal({ modal, setModal }: { modal: any, setModal: any }) {
    ...
    return (
        <div className="relative">
            ...
            <div className="t w-[90vw] md:w-[50vw] h-[60vh] bg-white rounded-lg shadow-2xl overflow-auto">
                <div className=" mt-2 ml-5 -mb-2 flex items-center gap-x-2">
                ...
                <div className="p-5 mt-2 fontLan">
                    {
